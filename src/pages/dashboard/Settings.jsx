    ...
    return (
        <>
            ...
            <section className={`${styles.SettingsSection} `}>
                ...
                <PersonalInformantion id={id} fetched={fetched} username={userName} email={email} firstName={firstName} lastName={lastName} setFirstName={setFirstName} setLastName={setLastName} super={superSeller} verified={verifiedUser} />
...
const PersonalInformantion = (props) => {
    ...
    return (
        <div className={styles.ProfileInformationArea}>
            <div className="text-4xl p-5 flex items-center justify-between flex-wrap">
