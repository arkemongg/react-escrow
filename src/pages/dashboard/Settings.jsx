            ...
            <div className={styles.ProfileInformationArea}>
                ...
                <div className={styles.FormArea}>
                    <div className="inptGroup flex flex-col p-5">
                        ...
                        <input type="text" id='username' value="username" className="input input-bordered w-full max-w-xl " disabled />   
                    </div>
                    <div className="inptGroup flex flex-col p-5">
                        <label className='text-2xl pb-2' htmlFor="email">Email</label>
                        <input type="text" id='email' value="email@email.com" className="input input-bordered w-full max-w-xl" disabled />   
                    </div>
...
const SocialDetails = ()=>{
    return (
        <div className={styles.SociaDetailsArea}>
